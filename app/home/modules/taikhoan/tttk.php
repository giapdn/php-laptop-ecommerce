...
<style>
    ...
    * {
    ...
    .circle {
        ...
        /* Đặt kích thước */
        border-radius: 50%;
        /* Biến hình vuông thành hình tròn */
        overflow: hidden;
        /* Ẩn phần thừa nếu ảnh vượt ra khỏi hình tròn */
    }

    .circle img {
        width: 100%;
        /* Đảm bảo ảnh đầy đủ kích thước bên trong hình tròn */
        height: 100%;
        object-fit: cover;
        /* Mô tả cách ảnh sẽ bị căn chỉnh bên trong hình tròn */
    }
</style>
            ...
            <div class="overlay-container">
                <div class="overlay">
                    <div class="overlay-panel overlay-right">
                        ...
                        ?>
                        <br>
                        <button class="ghost">Đổi ảnh đại diện</button>
