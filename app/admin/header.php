        ...
        <div class="app-main">
            ...
            <nav class="sidebar bg-primary">
                <ul>
                    ...
                    <li>
                        <a href="index.php?act=quanlybienthe"><i class="fa-solid fa-mug-hot ico-side"></i>Quản lí biến thể</a>
                    </li>
                    ...
                    <li>
                        <a href="index.php?act=tintuc"><i class="fa-solid fa-comment-dots ico-side"></i>Quản lí tin tức</a>
                    </li>
                    <li>
