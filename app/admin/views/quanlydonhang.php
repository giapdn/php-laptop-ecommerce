        ...
        <div class="app-main">
            <div class="main-content">
                ...
                <table id="example" class="table table-striped" style="width:100%">
                    ...
                    } elseif ($_GET["act"] == "capnhatdonhang") {
                        $sql = "SELECT * FROM `donhang` WHERE trangThai != 'cancelConfirming' AND trangThai != 'canceled' AND trangThai != 'success'";
                        $result = pdo_query($sql);
                        foreach ($result as $re) {
                            echo '
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                        <div class="ok" style="display: flex; " >
                                            <form action="index.php?act=chitietdonhang&id=' . $re["id_donHang"] . '&flagg=capnhat" method="post" style="margin-right: 10px;">
                                                <div class="btn btn-warning">
                                                    <i class="fa-solid fa-pen-to-square"></i>
                                                    <input name="suadonhang"  class="btn btn-warning" type="submit" value="Cập nhậtt">
                                                </div>
                                            </form>
                                            </div>
                                        </td>
                            ...
                            echo '
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                        <div class="ok" style="display: flex; " >
                                            <form action="index.php?act=chitietdonhang&id=' . $re["id_donHang"] . '" method="post" style="margin-right: 10px;">
                                                <div class="btn btn-warning">
                                                    <i class="fa-solid fa-pen-to-square"></i>
                                                    <input name="suadonhang"  class="btn btn-warning" type="submit" value="Chi tiết">
                                                </div>
                                            </form>
                                            </div>
                                        </td>
